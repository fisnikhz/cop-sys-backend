...
Route::group(['middleware' => ['auth:sanctum'], 'prefix' => '/v1/', 'as' => 'api.'], function () {
    Route::middleware(['auth', \App\Http\Middleware\OfficerMiddleware::class])->group(function () {
        //Personnel API
        ...
        Route::get('/conversations', [ConversationController::class, 'getAllConversations']);
